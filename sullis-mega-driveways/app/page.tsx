      ...
      <section className="py-16 bg-brand-card border-b border-brand-border">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-white/70 text-lg leading-relaxed">
            At Sulli&apos;s Mega Driveways, we help homeowners across Bolton and Greater Manchester
            transform tired, damaged or outdated driveways into strong, attractive, long-lasting
            surfaces built to stand the test of time.
          </p>
